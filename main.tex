...
We used a high resolution 3D scanner to scan in the objects. \tompson{Wow-wow-wow-wow, you need to go into more detail here. What brand is the scanner? What method does it use? etc etc. This is super important in order to reproduce the results and is a non-trivial amount of work!}  %The scanner is shown in Figure \ref{fig:david}.  
